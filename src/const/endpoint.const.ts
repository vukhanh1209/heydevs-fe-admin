...
export const UPDATE_REVIEW_STATUS = "update-status-company-review";
export const UPDATE_POST_STATUS = "update-post-job-status";
export const UPDATE_APPLICATION_STATUS = "update-application-job-status";

export const GET_ALL_JOBS = "get-all-job-with-application";
